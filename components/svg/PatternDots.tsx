...
function PatternDots(
  ...
  return (
    <svg width={130} height={462} xmlns="http://www.w3.org/2000/svg" {...props}>
      <g transform="rotate(-180 65 231)" fill={props.fill} fillRule="evenodd">
        <rect
          className="prefix__hidden prefix__sm:block"
          width={6.002}
          height={6.005}
          rx={3.001}
        />
